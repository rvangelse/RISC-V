...
#Si la cantidad de elementos mayores a 0xA0 es mayor a la mitad de la longitud del array "notas", entonces se carga el valor inmediato 1 en a0
#Caso contrario, se carga el valor inmediato 0 en a0

.data

    notas: .byte 0xA1 0x00 0xA1 0xA7
    longitud: .byte 4
...
.text
    ...
    li t1, 0 #Cargo el valor inmediato 0 en t1, t1 sera la cantidad de elementos mayores a 0xA0(s2) en el array "notas"
    ...
    while:
        ...
        blt s2, t2, sumo #Realizo una comparacion entre t2 y s2(0xA0). Si el elemento en t2 es mayor a s2(0xA0), salto a la etiqueta "sumo"
        j continue #Si no, salto a la etiqueta "continue"

        sumo:

            addi t1, t1, 1 #Sumo 1 al valor previo de t1(cantidad de elementos mayores a 0xA0(s2) en el array "notas")
    ...
    Comparacion:
        ...
        blt s1, t1, devuelveUno #Si s1(longitud del array "notas"/2) es menor a t1(cantidad de elementos mayores a 0xA0(s2) en el array "notas"), salta a la etiqueta "devuelvoUno"
...
#Al finalizar la ejecucion del programa, el valor cargado en a0 deberia ser 1 porque mas de la mitad de los valores valen mas que 0xA0