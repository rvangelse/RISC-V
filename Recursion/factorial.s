...
.text
    ...
    j fin #Cuando regresa de la llamada, termino la ejecucion el programa

    factorial:

        addi sp, sp, -8 #Reservo 2 espacios de la pila
        sw ra, 0(sp) #En el primer espacio de la pila guardare la direccion de retorno(ra)
        sw a0, 4(sp) #En el segundo espacio de la pila guardare el valor previo de a0
    ...
    epilogo:
        ...
        addi sp, sp, 8 #Restauro las 2 posiciones que le habia pedido a la pila
